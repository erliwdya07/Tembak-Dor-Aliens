...
var height;
var game;
var backImage = new createjs.Bitmap("assets/back.jpg");
...
function showMenu(){
	...
	if(showMenu.menu === undefined){
		...
		var label = new createjs.Text("Pilih Tingkat Kesulitan", "bold 24px Helvetica", "#ffffff");
		...
		showMenu.pages = [];
		var captions = [
			"0 - Pemula", "1 - normal", "2 - sedang", "3 - sulit", "4 - sangat sulit", "5 - lebih sulit lagi",
			"6 - luar biasa sulit", "7 - Veteran", "8 - Elite", "9 - jangan coba-coba", "10 - Gila",
			"11 - terahir", "12 - Astronomis", "-1 - mode bertahan"];
...
function reset(){
	if(confirm("kamu yakin mau reaload ini game...?")){
		localStorage.clear();
		init();
	}
}
